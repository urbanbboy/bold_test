        ...
        return (
            <div className="relative w-full">
                <input
                    type={type}
                    className={cn(
                        "flex h-10 w-full bg-transparent px-3 py-2 text-secondary text-base border-b-2 placeholder-gray2 focus-visible:outline-none focus-visible:border-b-graphic-light transition duration-200 disabled:cursor-not-allowed disabled:opacity-50",
